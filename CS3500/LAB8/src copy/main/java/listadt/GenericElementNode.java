...
public class GenericElementNode<T> implements GenericListAdtNode<T> {
  ...
  /**
   * Creates a list with the given object at the front.
   * Both arguments can be null.
   *
   * @param object the object to place in the front of the list
   * @param rest rest of the list
   */
  public GenericElementNode(T object, GenericListAdtNode<T> rest) {
    this.object = object;
    this.rest = rest;
  }
