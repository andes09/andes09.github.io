...
public class SpreadSheetController {
  ...
  /**
   * Gets the number associated with the given letter.
   *
   * @param rowLetters the letters for a row in a spreadsheet
   * @return the number for that letter
   * @throws IllegalArgumentException if the argument is not a letter
   */
  ...
  /**
   * Transmits the given message to the user.
   *
   * @param message message to send
   * @throws IllegalStateException if transmitting the message fails for any reason
   */
  ...
  /**
   * Transmits the entire menu to the user.
   *
   * @throws IllegalStateException any message fails to transmit for any reason
   */
  ...
  /**
   * Transmits the welcome message and menu to the user.
   *
   * @throws IllegalStateException transmission fails for any reason
   */
  ...
  /**
   * Transmits the ending message to the user.
   *
   * @throws IllegalStateException transmission fails for any reason
   */
